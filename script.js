...
function drag(e){ if(!isDragging)return; const currentX=e.type.includes('mouse')?e.clientX:e.touches[0].clientX; const currentY=e.type.includes('mouse')?e.clientY:e.touches[0].clientY; const deltaX=currentX-startX; const deltaY=currentY-startY; cubeRotationY+=deltaX*0.5; cubeRotationX-=deltaY*0.5; updateCubeRotation(); startX=currentX; startY=currentY; }
